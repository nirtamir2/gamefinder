...
>(({ children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      <div className="max-h-drawer overflow-auto">
        <div className="mx-auto mt-4 h-2 w-24 rounded-full bg-transparent" />
        {children}
      </div>
    </DrawerPrimitive.Content>
  </DrawerPortal>
...
) => <div className="grid gap-1.5 p-4 text-center xl:text-left" {...props} />;
